        ...
        <div className='content-animate md:flex h-[450px] border  border-gray-800 bg-body overflow-y-auto '>
            <div className='md:w-3/5 w-full'>
                <div className='relative group transition-all p-10 border-r border-b border-gray-800 overflow-hidden'>
                    <img className='md:h-[50vh] h-[30vh] w-full filter brightness-[0.2]' src={productFiltering}></img>
                    <div className='absolute max-w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                        <p className='text-lg text-[#4bffa5] text-center'>Product Filtering</p>
                    </div>
                    <div className='absolute flex flex-col items-center gap-2 text-justify -left-full -bottom-full h-full w-full p-8  bg-primary group-hover:bottom-0 group-hover:left-0 transition-all duration-1000 text-body '>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Description:</span> It is an ecommerce product category page. At your backend, you can create unlimited Filtering Options with Unlimited values for each one. 
                            Like, Categories, Brands, Warranty, Sellers etc. You can create a product as well if you feel necessary.</p>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Technology use: </span>Python, Django , Django Rest Framework, HTML, CSS, Bootstrap </p>
                ...
                <div className='relative p-10 group border-r border-b transition-all border-gray-800 overflow-hidden'>
                    <img className='md:h-[50vh] h-[30vh] w-full filter brightness-[0.2]' src={bdNote}></img>
                    <div className='absolute max-w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                    ...
                    <div className='absolute gap-2 text-justify -left-full -bottom-full h-full w-full p-8  bg-primary group-hover:bottom-0 group-hover:left-0 transition-all duration-1000 text-body '>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Description:</span>  I completed Bangladesh banknote Detection using deep learning techniques from the banknote
                        ...
                        <p className='md:text-sm text-xs '> <span className='md:text-base text-xs font-bold'>Technology use: </span>TensorFlow, Keras, CNN Model, Matplotlib </p>
            ...
            <div className='md:w-2/5 w-full '>
                <div className='relative h-[40vh] p-10 border-b border-gray-800 overflow-hidden group transition-all'>
                    ...
                    <div className='absolute flex flex-col items-center gap-2 text-justify -left-full -bottom-full h-full w-full p-4  bg-primary group-hover:bottom-0 group-hover:left-0 transition-all duration-1000 text-body '>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xsfont-bold'>Description:</span> It is a simple search engine like Google. Everything will be stored in the database when the user searches in this search engine like, search keyword, searched time, username, email user search. As, we
                         mean by search history.</p>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Technology use:</span>Python, Django, HTML, CSS, Bootstrap </p>
                        <a href=': https://github.com/momen105/SearchEngine' className='text-body text-2xl border border-gray-800 p-1 rounded-[50%] '><FaGithub /></a>
                    </div>
                </div>
                <div className='relative h-[40vh] p-10 border-b- border-gray-800 overflow-hidden group transition-all'>
                    ...
                    <div className='absolute flex flex-col items-center gap-2 text-justify -left-full -bottom-full h-full w-full p-4  bg-primary group-hover:bottom-0 group-hover:left-0 transition-all duration-1000 text-body '>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Description:</span>This is a web application that allows users to create photo albums, upload photos, and share
                ...
                <div className='relative h-[40vh] p-10 border-b border-gray-800 overflow-hidden group transition-all'>
                    ...
                    <div className='absolute flex flex-col items-center gap-2 text-justify -left-full -bottom-full h-full w-full p-4  bg-primary group-hover:bottom-0 group-hover:left-0 transition-all duration-1000 text-body '>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Description:</span>Delivery management system project Where have three panels for users. Admin panel, Seller panel, and Employee panel.</p>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Technology use:</span>Python, Django, HTML, CSS, Bootstrap, sslcommerz payment gateway </p>
                ...
                <div className='relative h-[40vh] p-10 border-l border-gray-800 overflow-hidden group transition-all'>
                    ...
                    <div className='absolute flex flex-col items-center gap-2 text-justify -left-full -bottom-full h-full w-full p-4  bg-primary group-hover:bottom-0 group-hover:left-0 transition-all duration-1000 text-body '>
                        <p className='md:text-sm text-xs'> <span className='md:text-base text-xs font-bold'>Description:</span>This is a e-commerce project. All personal information of users & purchased product history
